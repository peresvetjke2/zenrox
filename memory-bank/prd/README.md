...
- [`PRD-001-first-capture-and-retrieval-loop.md`](PRD-001-first-capture-and-retrieval-loop.md) — первый MVP-контур `zenrox`: сохранить одну личную задачу одной текстовой репликой, получить краткое подтверждение и выполнить retrieval списка открытых задач.
- [`PRD-002-conversational-routing-for-core-assistant-actions.md`](PRD-002-conversational-routing-for-core-assistant-actions.md) — следующий capability-layer `zenrox`: убрать зависимость от жестких команд и ввести natural-language routing для базовых task-действий в conversational канале.
