...
- [`PRD-001-first-capture-and-retrieval-loop.md`](PRD-001-first-capture-and-retrieval-loop.md) — первый MVP-контур `zenrox`: сохранить одну основную задачу или заметку из свободного текста, получить краткое подтверждение и выполнить простой retrieval по накопленным данным.
